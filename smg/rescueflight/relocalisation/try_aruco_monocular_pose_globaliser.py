...
def main() -> None:
    ...
    pose_globaliser: ArUcoMonocularPoseGlobaliser = ArUcoMonocularPoseGlobaliser(debug=True)
        ...
        with MonocularTracker(
            ...
            try:
                ...
                while True:
                    ...
                    state: ArUcoMonocularPoseGlobaliser.EState = pose_globaliser.get_state()
                    if state == ArUcoMonocularPoseGlobaliser.ACTIVE:
                    ...
                    elif state == ArUcoMonocularPoseGlobaliser.TRAINING:
                    ...
                    elif state == ArUcoMonocularPoseGlobaliser.UNTRAINED:
