...
./reconstruct_scannet_scene.sh "$1" "gt_gt" gt gt --max_depth=4.0
...
./reconstruct_scannet_scene.sh "$1" "mvdepth2_4m_gt" mvdepth2 gt --max_depth=4.0 --no_depth_postprocessing
./reconstruct_scannet_scene.sh "$1" "mvdepth2_pp_4m_gt" mvdepth2 gt --max_depth=4.0
